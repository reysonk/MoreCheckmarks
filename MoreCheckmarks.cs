            ...
            try
            {
                ...
                if (item.MarkedAsSpawnedInSession)
                {
                    if (MoreCheckmarksMod.includeFutureQuests)
                    {
                        ...
                        {
                            gotQuest = true;
                            ___string_5 = "\n" + "\nНужно (<color=#dd831a>" + possessedQuestCount + "</color>/" + totalItemCount + ") чтобы начать квест" + (gotMoreThanOneStartQuest ? "ы" : "") + ":\n  " + questStartString;
                        }
                        ...
                        {
                            gotQuest = true;
                            ___string_5 += "\n" + "\nНужно (<color=#dd831a>" + possessedQuestCount + "</color>/" + totalItemCount + ") чтобы завершить квест" + (gotMoreThanOneCompleteQuest ? "ы" : "") + ":\n  " + questCompleteString;
                        }
                    }
